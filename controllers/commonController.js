  ...
  exports.getAllClass= async (req, res, next) => {
    ...
    try{
      ...
      for(const classID of classIDS) {
        ...
        console.log(classDB)
        classes.push({ name: classDB.subject, url: 'http://164.90.230.104:5000/api/teacher/class/'+classID });
      } */
...
exports.getAllTask= async (req, res, next) => {
  ...
  try{
    ...
    for(const assignmentID of assignmentIDS) {
      ...
      runningAssignment.push({ name: assignmentDB.title, url: 'http://164.90.230.104:5000/api/teacher/class/get-task/'+assignmentID });
    }
...
exports.getAllResources= async (req, res, next) => {
  ...
  try{
    ...
    for(const resourceID of resourceIDS) {
      ...
      resource.push({ name: resourceDB.title, url: 'http://164.90.230.104:5000/api/teacher/class/resource/'+assignmentID, file: resourceDB.resourceFile });
    }
        ...
        const response = {
          ...
          book: docs.map(doc => {
            return {
              ...
              request: {
                type: "GET",
                url: "http://164.90.230.104:5000/api/admin/book/" + doc.id
              }
            };
          })
        };
      ...
      .then(doc => {
        ...
        if (doc) {
          res.status(200).json({
              ...
              request: {
                  type: 'GET',
                  url: 'http://164.90.230.104:5000/api/admin/books'
              }
          });
        } else {
          res
