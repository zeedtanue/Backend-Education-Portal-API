      ...
      const response = {
        ...
        user: docs.map(doc => {
          return {
            ...
            request: {
              type: "GET",
              url: "https://creatixa-student-portal.herokuapp.com/api/admin/student/" + doc.id
            }
          };
        })
      };
      ...
      const response = {
        ...
        parent: docs.map(doc => {
          return {
            ...
            request: {
              type: "GET",
              url: "https://creatixa-student-portal.herokuapp.com/api/admin/parent/" + doc.id
            }
          };
        })
      };
      ...
      const response = {
        ...
        admin: docs.map(doc => {
          return {
            ...
            request: {
              type: "GET",
              url: "https://creatixa-student-portal.herokuapp.com/api/admin/admin/" + doc.id
            }
          };
        })
      };
      ...
      const response = {
        ...
        notice: docs.map(doc => {
          return {
            ...
            request: {
              type: "GET",
              url: "https://creatixa-student-portal.herokuapp.com/api/admin/notice/" + doc.id
            }
          };
        })
      };
    ...
    .then(doc => {
      ...
      if (doc) {
        res.status(200).json({
            ...
            request: {
                type: 'GET',
                url: 'https://creatixa-student-portal.herokuapp.com/api/admin/all-notice'
            }
        });
      } else {
        res
      ...
      const response = {
        ...
        section: docs.map(doc => {
          return {
            ...
            request: {
              type: "GET",
              url: "https://creatixa-student-portal.herokuapp.com/api/admin/section/" + doc.id
            }
          };
        })
      };
      ...
      const response = {
        ...
        className: docs.map(doc => {
          return {
            ...
            request: {
              type: "GET",
              url: "https://creatixa-student-portal.herokuapp.com/api/admin/class/" + doc.id
            }
          };
        })
      };
    ...
    .then(doc => {
      ...
      if (doc) {
        res.status(200).json({
            ...
            request: {
                type: 'GET',
                url: 'https://creatixa-student-portal.herokuapp.com/api/admin/class'
            }
        });
      } else {
        res
